...
<body>
	...
	<form action="guardarMonstruos" method="post">
		...
		<div class="form-group">
			<label for="exampleInputText1">Amenaza</label> <input type="text"
				class="form-control" id="amenaza" name="amenaza" placeholder="maneza"
				required>
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Tiene Celulas</label> <input type="text"
