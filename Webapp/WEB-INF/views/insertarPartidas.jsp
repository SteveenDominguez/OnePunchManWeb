...
<body>
	...
	<form action="guardarPartidas" method="post">
		<div class="form-group">
			<label for="exampleInputText1">Fecha (DD/MM/YYYY) incluyendo los "/"</label> <input type="text"
				class="form-control" id="fecha" name="fecha" placeholder="fecha"
				required>
		</div>
		<div class="form-group">
			<label for="exampleInputText1">¿Quien Ganó?</label> <select
				name="ganador">
		...
		<div class="form-group">
			<label for="exampleInputText1">¿Quien perdió?</label> <select
				name="perdedor">
				<c:forEach items="${heroes}" var="heroe">
					<option value="${heroe.id}">${heroe.nombre}</option>
				</c:forEach>
		...
		<div class="form-group">
			<label for="exampleInputText1">¿Que jugaron?</label> <select
				name="videojuego">
