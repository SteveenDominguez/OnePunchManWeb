...
<body>
	...
	<form action="guardarNuevoPatrocinador" method="post">
		<div class="form-group">
			<input type="text" style="visibility: hidden" class="form-control"
				name="id" id="id" required="required" value="${patrocinador.id}" />
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Nombre</label> <input type="text"
				class="form-control" id="nombre" name="nombre" placeholder="nombre"
				required value="${patrocinador.nombre}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Dinero</label> <input type="text"
				class="form-control" id="dinero" name="dinero" placeholder="dinero"
				required value="${patrocinador.dinero}">
		</div>
