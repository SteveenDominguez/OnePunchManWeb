...
<body>
	...
	<form action="guardarNuevoMonstruo" method="post">
		<div class="form-group">
			<input type="text" style="visibility: hidden" class="form-control"
				name="id" id="id" required="required" value="${monstruo.id}" />
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Nombre</label> <input type="text"
				class="form-control" id="nombre" name="nombre" placeholder="nombre"
				required value="${monstruo.nombre}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Amenaza</label> <input type="text"
				class="form-control" id="amenaza" name="amenaza" placeholder="amenaza"
				required value="${monstruo.amenaza}">
		</div>
		<div class="form-group">
			<label for="exampleInputText1">Tiene Celula</label> <input type="text"
				...
				required value="${monstruo.tiene_celula}">
		</div>
